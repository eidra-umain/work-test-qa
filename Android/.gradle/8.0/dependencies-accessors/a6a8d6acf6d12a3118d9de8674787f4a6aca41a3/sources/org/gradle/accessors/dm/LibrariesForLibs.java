...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public LibrariesForLibs(DefaultVersionCatalog config, ProviderFactory providers, ObjectFactory objects, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) {
         ...
         */
        public Provider<MinimalExternalModuleDependency> getRuntime() { return create("runtime"); }
     ...
     */
    public NativeLibraryAccessors getNative() { return laccForNativeLibraryAccessors; }
    ...
    public static class AndroidLibraryAccessors extends SubDependencyFactory {
        ...
        public AndroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getDriver() { return create("android.driver"); }
    ...
    public static class KtorClientLoggingLibraryAccessors extends SubDependencyFactory {
        ...
        public KtorClientLoggingLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for native (io.ktor:ktor-client-logging)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getNative() { return create("ktor.client.logging.native"); }
    ...
    public static class NativeLibraryAccessors extends SubDependencyFactory {
        ...
        public NativeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getDriver() { return create("native.driver"); }

    }

    public static class TestLibraryAccessors extends SubDependencyFactory {
        private final TestAnnotationsLibraryAccessors laccForTestAnnotationsLibraryAccessors = new TestAnnotationsLibraryAccessors(owner);
        ...
        public TestLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getCommon() { return create("test.common"); }

        /**
         * Returns the group of libraries at test.annotations
         */
        public TestAnnotationsLibraryAccessors getAnnotations() { return laccForTestAnnotationsLibraryAccessors; }

    }

    public static class TestAnnotationsLibraryAccessors extends SubDependencyFactory {

        public TestAnnotationsLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for common (org.jetbrains.kotlin:kotlin-test-annotations-common)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getCommon() { return create("test.annotations.common"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: serialisation (1.9.20)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getSerialisation() { return getVersion("serialisation"); }
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        public PluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Creates a plugin provider for serialisation to the plugin id 'org.jetbrains.kotlin.plugin.serialization'
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getSerialisation() { return createPlugin("serialisation"); }
