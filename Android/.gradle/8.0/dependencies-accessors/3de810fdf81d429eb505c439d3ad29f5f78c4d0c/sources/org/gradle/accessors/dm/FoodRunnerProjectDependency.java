...
@NonNullApi
public class FoodRunnerProjectDependency extends DelegatingProjectDependency {

    @Inject
    public FoodRunnerProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
